...
AW_CUSTOM_APP_TYPE = "CustomAppType"
AW_CUSTOM_APP_TYPE_LITERALS = []
...
def PostTechInitAttributes(Operator):
   ...
   AW_CUSTOM_APP_TYPE_LITERALS.append("Fronius")
   AW_CUSTOM_APP_TYPE_LITERALS.append("DhRobotics_PGC_140_RTU_RS485")
   AW_CUSTOM_APP_TYPE_LITERALS.append("Dhrobotics_PGC_RTU")
   AW_CUSTOM_APP_TYPE_LITERALS.append("Kempi")
   AW_CUSTOM_APP_TYPE_LITERALS.append("SKS")
   AW_CUSTOM_APP_TYPE_LITERALS.append("SKS_dryweld")
   AW_CUSTOM_APP_TYPE_LITERALS.append("iMIG")
   AW_CUSTOM_APP_TYPE_LITERALS.append("iMIG_dryweld")
   AW_CUSTOM_APP_TYPE_LITERALS.append("iROB401")
   AW_CUSTOM_APP_TYPE_LITERALS.append("iROB401_dryweld")
   attribCreator.AddEnum(AW_CUSTOM_APP_TYPE, AW_CUSTOM_APP_TYPE_LITERALS, AW_CUSTOM_APP_TYPE_LITERALS[0], PROCESS_ATTRIBUTE |USER_ATTRIBUTE | GLOBAL_ATTRIBUTE, AW_CUSTOM_APP_TYPE)
