...
def PostWmInitAttributes(Operator):
   ...
   try:
      ...
      attribSetter.SetEnumIndex(WM_MOTION_TYPE, 0)

      searchMoTypeIndex = attribGetter.GetEnumIndex(WM_MOTION_TYPE)
      attrib = attribCreator.AddEnum(AW_MOTION_TYPE_FIRST_TPE, AW_MOTION_TYPE_FIRST_TPE_LITERALS, AW_MOTION_TYPE_FIRST_TPE_LITERALS[searchMoTypeIndex], OPERATION_ATTRIBUTE, AW_MOTION_TYPE_FIRST_TPE)
