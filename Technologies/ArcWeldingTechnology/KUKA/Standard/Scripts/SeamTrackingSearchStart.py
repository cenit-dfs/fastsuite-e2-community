# -------------------------------------------------------------------------------------------
# Name: SeamTrackingSearchStart
# Description: # Turns on Seam Tracking Search Start Manually for cases like box welding
...
FILE_NAME = "SeamTrackingSearchStart.py: "
...
# 
def GetEventName():
   return "SeamTrackSearchStart"
   
def GetEventUuId():
   return "bd8ff82e-7043-4390-971e-7a7498ecb145"
