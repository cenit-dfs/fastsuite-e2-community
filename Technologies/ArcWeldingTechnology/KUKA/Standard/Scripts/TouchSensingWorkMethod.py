...
AW_SEAMFIND_TEACH_TSWM_EVENT_NAME    = "SeamFindTeachTSWMEvent"
PY_SEAMFIND_TEACH_TSWM_EVENT_FILE    = "SeamFindTeachTSWMEvent.py"
...
AW_SEAMFIND_TEACH_RULE_NAME = "SeamFindTeachRule"
AW_SEAMFIND_TEACH_EVENT_NAME = "SeamFindTeachEvent"
AW_SEAMFIND_TEACH_EVENT_FILE = "SeamFindTeachEvent.py"
AW_TOUCHSENSING_RULE_NAME = "TouchSensingRule"
AW_TOUCHSENSING_EVENT_NAME = "TouchSensingEvent"
...
def PostWmInitAttributes(Operator : CENPyOlpWM_AttribInitOperator):
   ...
   try:
      ...
      attrib = attribCreator.AddEnum(AW_MOTION_TYPE_FIRST_TPE, AW_MOTION_TYPE_FIRST_TPE_LITERALS, AW_MOTION_TYPE_FIRST_TPE_LITERALS[searchMoTypeIndex], USER_ATTRIBUTE | GLOBAL_ATTRIBUTE | OPERATION_GROUP_ATTRIBUTE | OPERATION_ATTRIBUTE | PROCESS_ATTRIBUTE, AW_MOTION_TYPE_FIRST_TPE)
   ...
   # get the TechTabFolder 
   jsonSearchFile = Operator.GetTechTabFolder("SeamFind_Recipes.json")
   jsonPath = os.path.dirname(jsonSearchFile)
   attribTTF = attribCreator.AddString(AW_KUKA_TECH_TAB_FOLDER, jsonPath, USER_ATTRIBUTE | GLOBAL_ATTRIBUTE | PROCESS_ATTRIBUTE, AW_KUKA_TECH_TAB_FOLDER)
   attribTTF.SetVisibility(False)
...
def PostWmInitEvents(Operator : CENPyOlpWM_EventInitOperator):
   ...
   # SeamFinding
   Operator.RegisterPyTechnologyEvent(PY_SEAMFIND_TEACH_TSWM_EVENT_FILE)
   Operator.RegisterPyTechnologyEvent(PY_SEAMFIND_SCAN_EVENT_FILE)
   Operator.RegisterPyTechnologyEvent(PY_SEAMFIND_REF_EVENT_FILE)
   Operator.RegisterPyTechnologyEvent(PY_LINELASERPOV_EVENT_FILE)
   Operator.RegisterPyTechnologyEvent(AW_SEAMFIND_TEACH_EVENT_FILE)
...
def PostWmInitRules(Operator : CENPyOlpWM_RuleInitOperator):
   ...
   #Operator.RemoveEventFromRule(AW_TOUCHSENSING_RULE_NAME, AW_TOUCHSENSING_EVENT_NAME)
   # Add SeamFindTeachEvent event
   Operator.AddPyEvent(AW_SEAMFIND_TEACH_RULE_NAME, AW_SEAMFIND_TEACH_EVENT_NAME)     
   Operator.SetActivePyEvent(AW_SEAMFIND_TEACH_RULE_NAME, AW_SEAMFIND_TEACH_EVENT_NAME)
...
# def PostWmOnFrameChanged(Operator : CENPyOlpFrameChangedOperator):
#    # get logger
#    logging = Operator.GetLoggerOperator()
#    # debug logging
