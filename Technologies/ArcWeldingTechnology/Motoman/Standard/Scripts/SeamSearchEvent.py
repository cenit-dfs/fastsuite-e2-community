...
# Description: adding touch points with respect to Standard Yaskawa. 
...
AW_SEAMSEARCH_MOTION_TYPE_FIRST_TPE = "SeamSearchMotionTypeFirstTpe"
AW_SEAMSEARCH_TOUCH_DIRECTION = "SeamSearchTouchDirection" # AlongFaceToNormal = 0, AlongBaseFrame = 1
AW_SEAMSEARCH_SENSING_LENGTH = "SeamSearchSensingLength"
AW_SEAMSEARCH_OVERTRAVEL_LENGTH = "SeamSearchOvertravelLength"
AW_SEAMSEARCH_SENSING_SPEED="SeamSearchSensingSpeed"
AW_SEAMSEARCH_APPR_RETR_SPEED="SeamSearchApprRetrSpeed"
AW_SEAMSEARCH_APPR_RETR_FLYBY="SeamSearchTouchDirectionApprFlyBy"
