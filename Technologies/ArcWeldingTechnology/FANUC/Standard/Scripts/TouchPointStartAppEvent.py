...
def PostInitAttributes(Operator):
   ...
   # download attribute
   attribCreator.AddInt(AW_TOUCH_BASE_DIRECTION, 0, 0, 6, OPERATION_ATTRIBUTE | PROCESS_ATTRIBUTE, AW_TOUCH_BASE_DIRECTION)
...
def GetEventUuId():
   return "5b4dcd32-d29b-11ec-9d64-0242ac120002"
