...
FILE_NAME = "PointRetractTechEndEvent.py: "
...
def PostCompute(Operator):
   # get logger
   logging = Operator.GetLoggerOperator()
   #logging.LogDebug(".................................PointRetractTechEndEvent :: PostCompute")
   # get event operator
   ...
   #-----------------------------------
   feedrate = attribGetter.GetDouble(RETRACT_SPEED)
...
# 
def GetEventName():
   return "PointRetractTechEndEvent"
   
def GetEventUuId():
   return "A10546E2-D296-4F0C-8885-59718C547A06"
